...
export default function SocialLinks() {
  return (
    <div className="flex gap-2 mt-2">
      <Tooltip title="Gmail" enterTouchDelay={1}>
      ...
      <Tooltip title="GitHub" enterTouchDelay={1}>
      ...
      <Tooltip title="LinkedIn" enterTouchDelay={1}>
      ...
      <Tooltip title="Instagram" enterTouchDelay={1}>
      ...
      <Tooltip title="YouTube" enterTouchDelay={1}>
